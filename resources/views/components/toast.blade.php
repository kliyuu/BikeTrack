@props([
  'soundEffect' => false,
  'displayDuration' => 3000, // default 3000 ms
  'autoDismiss' => true,
])
...
<div x-data="{
    notifications: [],
    displayDuration: @js($displayDuration),
    soundEffect: @js($soundEffect),
  ...
  <div x-on:mouseenter="$dispatch('pause-auto-dismiss')" x-on:mouseleave="$dispatch('resume-auto-dismiss')"
    class="group pointer-events-none fixed inset-x-8 top-0 z-99 flex max-w-full flex-col gap-2 bg-transparent px-6 py-6 md:top-0 md:left-[unset] md:right-0 md:bottom-[unset] md:max-w-sm">
