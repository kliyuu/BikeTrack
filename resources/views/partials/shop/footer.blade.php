<footer class="bg-white w-full dark:bg-zinc-900">
  <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-10 lg:px-8">
    <div class="sm:flex sm:items-center sm:justify-between">
      <div class="flex items-center text-teal-600">
        <img src="{{ asset('images/bikerzone.jpg') }}" alt="Logo" class="h-14 w-auto" />
        <span class="ml-2 text-lg font-semibold">BikerZone</span>
      </div>
